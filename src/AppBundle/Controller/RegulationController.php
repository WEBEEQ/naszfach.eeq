<?php
// src/AppBundle/Controller/RegulationController.php
...
class RegulationController extends Controller
{
     ...
     * @Route("/regulamin")
     */
    public function regulationAction(Request $request)
    {
        ...
        return $this->render('regulation/regulation.html.twig', array(
